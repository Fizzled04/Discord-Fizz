...
class Help(View):
    ...
    def help_embeds(self):
        embeds = [
            ...
            discord.Embed(title="Help | Fizz Casino", description="General Commands, this section will contain the self explanitory commands!\n\n**/balance** --- This command shows you your balance of chips\n\n**/pay (amount) (@user)** --- This does what you'd expect, it pays a user chips from your bank\n\n**/daily** --- This command allows you to collect 150 chips daily(every 24 hours).", color=discord.Color.blue()).set_footer(text="2/5"),
